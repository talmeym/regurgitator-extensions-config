...
public abstract class JsonParameterLoader {
	protected Step buildJsonParameter(String id, ParameterPrototype prototype, String context, String source, String value, String file, ValueProcessor processor, String jsonPath, Log log) throws RegurgitatorException {
		int numberSet = 0;
