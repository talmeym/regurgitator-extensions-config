...
public abstract class VelocityProcessorLoader {
	protected ValueProcessor buildVelocityValueProcessor(String value, String file, Log log) throws RegurgitatorException {
		int numberSet = 0;
